...
<body>
	<div id="wrapperlogin">
		...
		<form name="cPanelLogin" method="post" action="LoginServlet">
			<fieldset >
				<div  style="padding:20px;">
				<p>
					<label for="username">Username:</label> <input class="loginInput" name="username" type="text" value="" />
				</p>
				<p>
				...
				<p>
					<a href="../register.html">Register new account</a>
								...
								<p>
					<a href="./login_company.jsp">Partner login</a>
				</p>
				</div>
			</fieldset>
		</form>
